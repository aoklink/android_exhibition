...
public abstract class FrameworkBaseFragment<V extends BaseMvpView, P extends BaseMvpPresenter<V>> extends MvpFragment<V, P> {
    ...
    public void showLoadingStatus() {
        if (getActivity() instanceof FrameworkBaseActivity) {
            ((FrameworkBaseActivity) getActivity()).showLoadingStatus();
        }
    }
    ...
    protected void loadingEnable(boolean enable) {
        if (getActivity() instanceof FrameworkBaseActivity) {
            ((FrameworkBaseActivity) getActivity()).loadingEnable(enable);
        }
    }
    ...
    public void hideLoadingStatus() {
        if (getActivity() instanceof FrameworkBaseActivity) {
            ((FrameworkBaseActivity) getActivity()).hideLoadingStatus();
        }
    }
