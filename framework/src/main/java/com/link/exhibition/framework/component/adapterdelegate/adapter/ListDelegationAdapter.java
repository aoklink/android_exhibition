package com.link.exhibition.framework.component.adapterdelegate.adapter;

import com.link.exhibition.framework.component.adapterdelegate.AdapterDelegate;
import com.link.exhibition.framework.component.adapterdelegate.AdapterDelegatesManager;
import com.link.exhibition.framework.component.adapterdelegate.display.BaseDisplayList;
import com.link.exhibition.framework.component.adapterdelegate.display.SimpleDisplayList;
...
//            notifyItemChanged(index);
     ...
     * @param object
     */
    public final void insertElement(T object , int position) {
        if (!items.contains(object)) {
            items.add(position, object);
            notifyItemInserted(items.displayPosition(object));
            notifyItemRangeChanged(items.displayPosition(object), items.size());
        }
    }
