package com.link.exhibition.framework.component.adapterdelegate.display;

/**
 * Created on 2019/1/8  16:30
 * chenpan pan.chen@linkfeeling.cn
 */
@SuppressWarnings("unused")
public final class SimpleDisplayList <T> extends BaseDisplayList<T> {
