package com.link.exhibition.framework.utils.data;
...
//        return getString(KeysConstants.USER_TYPE);
    ...
    public static String getName() {
        return getString(KeysConstants.NAME);
    }

    public static void setName(String value) {
        putString(KeysConstants.NAME, value);
    }

    public static void setSex(int sex) {
        putInt(KeysConstants.SEX, sex);
    }

    public static String getSex() {
        return getInt(KeysConstants.SEX) == 1 ? "男" : "女";
    }

    public static void setOpenId(String openId) {
        putString(KeysConstants.OPEN_ID, openId);
    }

    public static String getOpenId() {
        return getString(KeysConstants.OPEN_ID);
    }

    public static void setFitness(String fitness) {
        putString(KeysConstants.FITNESS, fitness);
    }

    public static String getFitness() {
        return StringUtils.isEmpty(getString(KeysConstants.FITNESS)) ? KeysConstants.ALL : getString(KeysConstants.FITNESS);
    }
