package com.link.exhibition.mvp.delegate.impl
...
import com.link.exhibition.mvp.BuildConfig
...
import com.link.exhibition.mvp.presentermanager.PresenterManager
import com.link.exhibition.mvp.utils.ContextUtils.toViewId
import com.link.exhibition.mvp.utils.FragmentUtils.isInBackStack

/**
 * Created on 2019/1/14  10:29
 * chenpan pan.chen@linkfeeling.cn
 */
open class FragmentMvpDelegateImpl<V : MvpView, P : MvpPresenter<V>>(val fragment: androidx.fragment.app.Fragment,
     ...
     */
    private fun retainPresenterInstance(activity: Activity, fragment: androidx.fragment.app.Fragment,
