package com.link.exhibition.mvp.presentermanager
...
object PresenterManager {
    ...
    private val ACTIVITY_MAP: androidx.collection.ArrayMap<Activity, String> = androidx.collection.ArrayMap()

    private val ACTIVITY_SCOPED_CACHE_MAP: androidx.collection.ArrayMap<String, ActivityScopedCache> = androidx.collection.ArrayMap()
